...
export const metadata: Metadata = {
  title: "Imad & Nour - Engagement Invitation - 4:00 PM",
  description:
    "Join us for our engagement celebration on August 17th, 2025 at 4:00 PM. An evening of love & celebration awaits!",
  ...
  openGraph: {
    ...
    description:
      "Join us for our engagement celebration on August 17th, 2025 at 4:00 PM. An evening of love & celebration awaits!",
    url: 'https://imad-nour.vercel.app/400',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Imad & Nour Engagement Celebration - 4:00 PM",
      },
    ],
    locale: 'en_US',
    type: "website",
...
export default function Layout400({
  children,
}: {
